...
class CosmicFish_PlotSettings():
    ...
    :ivar D1_confidence_level: list with the confidence levels for the 1D plot. Default: [ 0.9545, 0.6827 ]
    ...
    :ivar D2_confidence_levels: list with confidence levels for the 2D plot. Default: [ 0.9545, 0.6827 ]      
    ...
    :ivar range_dim: Sets range in (tri)plots to the 1D or 2D chosen (2sigma) confidence level. Default: 2
    ...
    :ivar triplot_subspace_cm: spacing between subplots in triplot in cm. Default: 0.5 cm
    ...
    def __init__( self, dictionary=None, **kwargs ):
      ...
      #standard  
        ...
        self.D1_confidence_level     = [ 0.9545, 0.6827 ]      
        ...
        self.D2_confidence_levels    = [0.9545, 0.6827]
